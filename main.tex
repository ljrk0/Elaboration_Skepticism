...
Falls nein, ist er eventuell trotzdem sinnvoll in einem allgemeineren Kontext? %konkreter
...
Zusammenfassend kann man sagen, dass der epistemologische Skeptizismus ein sehr abstraktes Thema mit sehr \glqq\ einfachen\grqq\ Argumenten in sich konsistent zu behandeln versucht. Wenn man dies jedoch schon als \glqq\ Flucht\grqq\ bezeichnet, hat man vorschnell geurteilt.
...
%Ende:
Wenn man weiter prüft, muss man eingestehen, dass der Skeptizismus in der Hinsicht von Nutzen ist als dass er einen mit dem Mittel ausstattet, aktiv vom täglichen praktischen Dogmatismus zurückzukehren und alles zu hinterfragen.
	\subsection{Schluss}
